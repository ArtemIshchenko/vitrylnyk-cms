...
class WebConsole
{
    ...
    public static function migrate($moduleId=null)
    {
        ob_start();
				
				$migrationPath = '@app/migrations';
				if($moduleId)
					$migrationPath = '@app/modules/' . $moduleId . '/migrations';
				self::console()->runAction('migrate', ['migrationPath' => $migrationPath, 'migrationTable' => 'migration', 'interactive' => false]);
