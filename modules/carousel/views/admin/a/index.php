...
$this->title = Yii::t('carousel', 'Карусель');
    ...
    <table class="table table-hover">
        ...
        <?php foreach($data->models as $item) : ?>
            <tr data-id="<?= $item->primaryKey ?>">
                ...
                <?php endif; ?>
                <td><a href="<?= Url::to(['/'.$module.'/admin/a/edit', 'id' => $item->primaryKey]) ?>"><img src="<?= $item->image ?>" style="width: 550px;"></a></td>
