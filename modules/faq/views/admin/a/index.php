...
$this->title = Yii::t('faq', 'Питання та відповіді');
...
<?php if($data->count > 0) : ?>
    ...
    <?php foreach($data->models as $item) : ?>
            <tr data-id="<?= $item->primaryKey ?>">
                ...
                <?php endif; ?>
                <td><a href="<?= Url::to(['/'.$module.'/admin/a/edit', 'id' => $item->primaryKey]) ?>"><?= StringHelper::truncate(strip_tags($item->question), 128) ?></a></td>
