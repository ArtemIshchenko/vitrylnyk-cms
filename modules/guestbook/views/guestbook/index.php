<?php
use app\modules\guestbook\api\Guestbook;
...
<div class="row">
    ...
    <div class="col-md-4">
        <?php if(Yii::$app->request->get(Guestbook::SENT_VAR)) : ?>
            <h4 class="text-success"><i class="glyphicon glyphicon-ok"></i> Повідомлення успішно додано</h4>
        <?php else : ?>
            <h4>Залишене повідомлення</h4>
