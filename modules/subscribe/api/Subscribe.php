<?php
namespace app\modules\subscribe\api;
...
class Subscribe extends \app\components\API
{
    ...
    public function api_form($options = [])
    {
        ...
        $form = ActiveForm::begin([
            ...
            'action' => Url::to(['/subscribe/admin/send']),
            'layout' => 'inline'
        ]);
        ...
        echo Html::submitButton(Yii::t('subscribe/api', 'Розіслати'), ['class' => 'btn btn-primary', 'id' => 'subscriber-send']);
