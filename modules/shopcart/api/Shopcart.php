<?php
namespace app\modules\shopcart\api;
...
class Shopcart extends \app\components\API
{
    ...
    public function api_form($options = [])
    {
        ...
        $form = ActiveForm::begin([
            'action' => Url::to(['/shopcart/admin/send'])
        ]);
        ...
        echo Html::submitButton(Yii::t('app', 'Відіслати'), ['class' => 'btn btn-primary']);
        ActiveForm::end();
