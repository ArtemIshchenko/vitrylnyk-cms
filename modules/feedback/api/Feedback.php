<?php
namespace app\modules\feedback\api;
...
class Feedback extends \app\components\API
{
    ...
    public function api_form($options = [])
    {
        ...
        $form = ActiveForm::begin([
            ...
            'action' => Url::to(['/feedback/admin/send'])
        ]);
        ...
        echo Html::submitButton(Yii::t('app', 'Відправити'), ['class' => 'btn btn-primary']);
        ActiveForm::end();
