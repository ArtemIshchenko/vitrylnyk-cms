...
$this->title = Yii::t('feedback', 'Зворотній зв\'язок');
...
<?php if($data->count > 0) : ?>
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th width="100"><?= Yii::t('feedback', 'Відповідь') ?></th>
                <th width="30"></th>
            </tr>
        </thead>
        <tbody>
    <?php foreach($data->models as $item) : ?>
            <tr>
                ...
                <?php endif; ?>
                <td><a href="<?= Url::to(['/'.$module.'/admin/a/view', 'id' => $item->primaryKey]) ?>"><?= ($this->context->module->settings['enableTitle'] && $item->title != '') ? $item->title : StringHelper::truncate($item->text, 64, '...')?></a></td>
